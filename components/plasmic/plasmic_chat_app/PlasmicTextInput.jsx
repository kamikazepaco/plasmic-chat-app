...
import sty from "./PlasmicTextInput.module.css"; // plasmic-import: D_5NwTMa2Ey/css
import SearchsvgIcon from "./icons/PlasmicIcon__Searchsvg"; // plasmic-import: mP6wsY2-5di/icon
import ChecksvgIcon from "./icons/PlasmicIcon__Checksvg"; // plasmic-import: 2VukVvM3mTt/icon
      ...
      {(
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <SearchsvgIcon
                className={classNames(projectcss.all, sty.svg__lsGxn)}
                role={"img"}
              />
            ),
      ...
      {(hasVariant(variants, "showEndIcon", "showEndIcon") ? true : true) ? (
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <ChecksvgIcon
                className={classNames(projectcss.all, sty.svg__pgNj)}
                role={"img"}
              />
            ),

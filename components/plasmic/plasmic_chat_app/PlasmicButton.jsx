...
import sty from "./PlasmicButton.module.css"; // plasmic-import: GoXSSwCM9cM/css
import ChecksvgIcon from "./icons/PlasmicIcon__Checksvg"; // plasmic-import: 2VukVvM3mTt/icon
import IconIcon from "./icons/PlasmicIcon__Icon"; // plasmic-import: DhFxhvmKV_h/icon
      ...
      {(
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <ChecksvgIcon
                className={classNames(projectcss.all, sty.svg__xe3ED)}
                role={"img"}
              />
            ),
      ...
      {(hasVariant(variants, "showEndIcon", "showEndIcon") ? true : false) ? (
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <IconIcon
                className={classNames(projectcss.all, sty.svg___3ExuS)}
                role={"img"}
              />
            ),
